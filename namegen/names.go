...
// copied from
// https://github.com/moby/moby/blob/06ca1606e1a09c36bd12ed503b4c99d8a17ca230/pkg/namesgenerator/names-generator.go

var (
	// Left are prefixes for the Right.
	...
	// Right are suffixes for the Left.
	// Docker, starting from 0.7.x, generates names from notable scientists and hackers.
	// Please, for any amazing man that you add to the list, consider adding an equally amazing woman to it, and vice versa.
	//nolint:gochecknoglobals,lll // Pregenerated list.
	Right = [...]string{
